...
-- Execute este script substituindo 'SEU_USER_ID' pelo seu user_id real

DO $$
DECLARE
    target_user_id UUID := 'SEU_USER_ID'; -- SUBSTITUA PELO SEU USER_ID
...
BEGIN
    -- Verificar se o user_id foi alterado
    IF target_user_id = 'SEU_USER_ID' THEN
        RAISE EXCEPTION 'ERRO: Você precisa substituir SEU_USER_ID pelo seu user_id real no script!';
    END IF;
    ...
    RAISE NOTICE 'Resultados: %', resultado_texto;
