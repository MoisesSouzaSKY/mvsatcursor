...
DROP FUNCTION IF EXISTS public.validate_employee_login(text, text);

-- Recriar função para retornar o user_id do proprietário
...
BEGIN
  ...
  RETURN QUERY SELECT 
    ...
    emp_record.is_admin,
    emp_permissions,
    emp_record.user_id; -- Retornar o user_id do proprietário
END;
$$;